...
function MyTemplateCard({ title, description, imgSrc, href }) {
  return (
    <Card className="transform transition-transform duration-500 ease-in-out hover:-translate-y-3 hover:shadow-xl hover:shadow-gray-200 max-w-sm bg-black border-zinc-700 border-2" imgAlt={title} imgSrc={imgSrc}>
